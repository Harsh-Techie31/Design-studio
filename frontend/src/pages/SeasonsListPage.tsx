        ...
        <form onSubmit={handleCreate} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              maxLength={12}
              className="w-full rounded-lg border border-line bg-ink px-3.5 py-2.5 font-mono text-sm text-bone placeholder:text-muted focus:border-accent focus:outline-none"
            />
          </div>
          <button
            type="submit"
