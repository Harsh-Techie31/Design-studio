              ...
              {refImages.map((ref) => {
                ...
                return (
                  <div key={ref.id} className="group relative">
                    ...
                    <div className="absolute left-0.5 top-0.5 rounded bg-brass/80 px-1 py-px text-[7px] font-bold text-ink">
                      {stageLabel}
                    </div>
                  </div>
                );
          ...
          {measureFields.map((field) => (
            <div key={field} className="flex items-center gap-2 rounded-lg border border-line bg-ink-soft px-2.5 py-1.5">
              ...
              <input
                ...
                className="w-14 rounded border border-line bg-ink px-1.5 py-0.5 text-right font-mono text-[11px] text-brass focus:border-brass/60 focus:outline-none"
              />
